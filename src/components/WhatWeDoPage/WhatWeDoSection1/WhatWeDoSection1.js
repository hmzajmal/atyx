          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 text-center">
              <div class="service-box mt-5 mx-auto">
                ...
                <p class="text-muted mb-0">
                  We provide hands-on design, development, testing and
                  deployment services in the following areas:​<br />
                  <ul>
            ...
            <div class="col-lg-6 col-md-6 text-center">
              <div class="service-box mt-5 mx-auto">
                ...
                <p class="text-muted mb-0">
                  We provide technology consulting services to help our clients
                  better implement systems and software within their
                  organizations:<br />
                  <ul>
                    <li>IT strategy</li>
          ...
          <div class="row">
            <div class="col-lg-12 col-md-6 text-center">
              <div class="service-box mt-5 mx-auto">
                ...
                <img class="icons mb-3 sr-icons" src={require("../../../icons/iot.svg")} />

                <h4 class="mb-3">New and Emerging Technologies</h4>
                <p class="text-muted mb-0">
                  We provide technical advisory and hands-on design and
                  development services for the following new and emerging
                  technologies:
                  <ul>
